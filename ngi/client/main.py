...
class GamepadClient:
    ...
    async def initialize(self) -> bool:
        ...
        if self.gamepad_handler.joystick:
            self.force_feedback_handler = ForceFeedbackHandler(self.gamepad_handler.joystick)
    ...
    def _handle_force_feedback(self, feedback: ForceFeedback):
        ...
        if self.force_feedback_handler:
            self.force_feedback_handler.send_force_feedback(feedback.force, feedback.duration)
            ...
            while self.running:
                ...
                if gamepad_state:
                    ...
                    if int(gamepad_state.timestamp * 10) % 10 == 0:  # Every second
                        self.logger.debug(f"Gamepad state - Steering: {gamepad_state.steering:.2f}, "
